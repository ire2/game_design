...
protected:
    ...
    /** The flattened path of the spline */

    cugl::Path2 _flattenedPath;

    cugl::Poly2 _extrudedSpline;

    std::vector<cugl::Poly2> containerHandles;

    std::vector<cugl::Poly2> containerKnobs;
    
    cugl::Poly2 _triangulatedStar;
    
    cugl::Vec2 _selectedKnob;
    
    cugl::Vec2 _prevMousePosition;
